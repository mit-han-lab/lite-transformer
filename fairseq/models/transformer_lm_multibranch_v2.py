...
from fairseq.models.transformer_multibranch_v2 import (
    Embedding,
    TransformerDecoder,
)
...
@register_model('transformer_lm_multibranch_v2')
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--use-all-embedding', default=False, action='store_true')
        parser.add_argument('--decoder-kernel-size-list', nargs='*', default=[15] * 2 + [31] * 4 + [63] * 11, type=int)
        # fmt: on
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_big')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_wiki103')
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_baevski_wiki103')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_wiki103_small')
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_baevski_wiki103_small')
def transformer_lm_baevski_wiki103_small(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 12)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
    args.dropout = getattr(args, 'dropout', 0.3)
    args.adaptive_input = getattr(args, 'adaptive_input', True)
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_gbw')
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_baevski_gbw')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_gpt')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_gpt2_small')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_gpt2_medium')
...
@register_model_architecture('transformer_lm_multibranch_v2', 'transformer_lm_multibranch_v2_gpt2_big')
